...
<body onload="ccgen();"style="background: #212121;">
	...
	<div class="container" id="container">
		...
		<!-- END OF FORMS -->
		<div class="footer" id="footer"><center><p style="color: #FFFFFF">Hosted by <pan><p <style="color: #ff0000">hades</p></pan></p></center></div>
	</div>
	...
	<script src="assets/js/Skchk.js"></script>
</body>
</html>